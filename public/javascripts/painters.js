...
Timeline.ThumbnailEventPainter.prototype.paint = function() {
   ...
   var createEventDiv = function(evt, highlightIndex) {
      ...
      var thumbnail = evt.getProperty("thumbnail");
      ...
      div.style.width = (p._thumbnailWidth + p._labelWidth)+'px';
      div.style.height = p._thumbnailHeight+'px';

      var img = doc.createElement("img");
      img.src = thumbnail;
      img.style.verticalAlign = "text-top";
      img.style.cssFloat = "left";
      img.style.border = "1px solid "+evt.getProperty("color");
      img.width = p._thumbnailWidth-2;
      img.height = p._thumbnailHeight-2;
      div.appendChild(img);
      ...
      Timeline.DOM.registerEvent(div, "mouseover", function(elmt, domEvt, target) {
         img.width = (p._thumbnailWidth*3)-2;
         img.height = (p._thumbnailHeight*3)-2;
         div.style.width = (p._thumbnailWidth*7 + p._labelWidth)+'px';
         div.style.height = (p._thumbnailHeight*3)+'px';
         div.style.backgroundColor = '#EEEEEE';
         div.style.border = '1px solid #999999';
         div.style.zIndex = 1000;
	 div.style.padding = '3px';
         div.style.left = (pixel-20)+ "px";
         div.style.top = (trackOffset-20) + "px";
      });
